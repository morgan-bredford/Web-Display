...
const Alt1 = (props) => {
    ...
    const link = e => {
        ...
        document.getElementById('choose_link_pic_container').style.display = 'none'
    }

    return(
        <div className="alt">
            <section id="choose_gallery_pic_container">
                <span onClick={() => document.getElementById('choose_gallery_pic_container').style.display = 'none'}>
                    Avbryt X
                </span>
                { 
                        ...
                        return (
                            <span onClick={ 
                                () => {
                                    ...
                                    document.getElementById('choose_gallery_pic_container').style.display = 'none' 
                                }
                            }>
            ...
            <section id="choose_link_pic_container">
            ...
            <section className="alt1_section">
                ...
                <section id="choose_media_container">
                    ...
                    <div className="pic_source_choice" id="choose_gallery_pic_label" onClick={ () => document.getElementById('choose_gallery_pic_container').style.display = 'flex' }>
                        Välj bild från ditt galleri
                    </div>
                    <div className="pic_source_choice" id="choose_link_pic_label" onClick={ () => document.getElementById('choose_link_pic_container').style.display = 'flex' }>
                        Klistra in länk till bild
                    </div>
               </section> 
            </section>
