    ...
    return(
        ...
        <div className="alt">
            ...
            <section className="preview_modal"  onClick={ e => {
                ...
                <div className="preview" style={{...fontOptions,width: `clamp(400px,${props.preview.text.length}px / 2,70vw)`}}>
                    <section>
                        <h1 className="preview_headline">{props.preview.headline}</h1>
                        <img src={props.preview.media} className="preview_blog_image" alt="" style={{width: `clamp(100px,${props.preview.text.length}px / 5,20vw)`}} />
                    ...
                    <div>
                        ...
                        <span className="preview_button" onClick={ () => props.publishEntry('blog') }>
                            Publicera
                        </span>
                    </div>
                </div>
